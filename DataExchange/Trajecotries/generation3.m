...
for i=1:1:length(t)
   x(i)=...
       R * f(t(i),L,k,10)* f(t(i),L,-k,14) - ...
       R * f(t(i),L,k,18)* f(t(i),L,-k,22) + ...
       R * f(t(i),L,k,26)* f(t(i),L,-k,30) - ...
       R * f(t(i),L,k,34)* f(t(i),L,-k,38) + ...
       R * f(t(i),L,k,42)* f(t(i),L,-k,46);
end

for i=1:1:length(t)
   y(i)=...
       R* f(t(i),L,k,12+2)*  f(t(i),L,-k,16+2) - ...
       R* f(t(i),L,k,20+2)*  f(t(i),L,-k,24+2) + ...
       R* f(t(i),L,k,28+2)*  f(t(i),L,-k,32+2) - ...
       R* f(t(i),L,k,36+2)*  f(t(i),L,-k,40+2) + ...
       R* f(t(i),L,k,44+2)*  f(t(i),L,-k,48+2);
end
